  ...
  <div class="MenuAddmodify_container">
    ...
    <div class="MenuAddmodify_box_wrap">
      ...
      <div class="MenuAddmodify_wrap">
        <form>
          <label class="MenuAddmodify_label form-label"
            ...
            <input 
              type="text" 
              class="MenuAddmodify_input form-control" 
      ...
      <div class="MenuAddmodify_btn_wrap">
        <label class="MenuAddmodify_label"
          >카테고리
          <button
            type="button"
            class="MenuAddmodify_edit_btn"
            @click="show = 1"
            data-bs-toggle="collapse"
            data-bs-target="#category_option"
            aria-expanded="false"
            aria-controls="category_option"
          >
            카테고리수정
          </button>
          <div class="category_option_bind">{{}}전체메뉴, 오늘의 커피, 딩동 시그니처</div>
          <div class="collapse category_option_wrap" id="category_option" v-if="show == 1">
        ...
        <label class="menuadd_label"
          ...
          <div class="collapse option_edit_wrap" id="option_edit" v-if="show == 2">
            <div class="card card-body">
